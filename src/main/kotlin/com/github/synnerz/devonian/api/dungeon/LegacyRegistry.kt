...
// Credits to https://github.com/Skytils/SkytilsMod/blob/2.x/mod/src/main/resources/assets/catlas/state2legacy.json
//  and me4502 most of the ids used here were not taken from it, but we used this list to make sure we were
//  in the right path
