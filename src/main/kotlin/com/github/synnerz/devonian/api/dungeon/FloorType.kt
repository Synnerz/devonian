...
enum class FloorType(
    ...
    val roomsW: Int,
    val roomsH: Int,
    val roomsWS: Int = roomsW,
    val roomsHS: Int = roomsH,
    ...
    Entrance(0, false, "E", 4, 4, 4, 4, "Entrance", 0.3, 1200, 9),

    F1(1, false, "F1", 4, 5, requiredPercent = 0.3),
    F2(2, false, "F2", 5, 5, requiredPercent = 0.4),
    F3(3, false, "F3", 5, 5, requiredPercent = 0.5),
    F4(4, false, "F4", 6, 5, 5, 5, requiredPercent = 0.6, requiredSpeed = 720),
    F5(5, false, "F5", 6, 6, 5, 6, requiredPercent = 0.7),
    F6(6, false, "F6", 6, 6, 5, 6, requiredPercent = 0.85, requiredSpeed = 720),
    ...
    M4(4, true, "M4", 6, 5, 5, 5, requiredSpeed = 480),
    M5(5, true, "M5", 6, 6, 5, 6, requiredSpeed = 480),
    M6(6, true, "M6", 6, 6, 5, 6, requiredSpeed = 480),
